...
responses = {
    ...
    "what's your name?": ["My name is " + bot_name + "."+"What is your name?"],
...
Public health measures such as mask-wearing, social distancing, and regular handwashing remain important tools in reducing the spread of the virus, along with vaccination. It's important to stay informed and follow the latest guidance from public health officials and medical experts'''],
    ...
    "types of corona virus": ['''Some of the common types of coronaviruses that infect humans include:
...
5.	SARS-CoV-2: This is the virus that causes COVID-19, which emerged in late 2019 and has caused a global pandemic.'''],
    ...
    "what is Symptoms of covid": ['''The symptoms of COVID-19 can vary from person to person, and some individuals may experience no symptoms at all. However, the most common symptoms of COVID-19 include:
1.	Fever or chills
2.	Cough
...
def get_response(user_input):
    ...
    if "i have fever" in user_input or "i have high fever" in user_input or "i experience fever" in user_input or "i am having fever" in user_input or "i am experiencing fever" in user_input or "i have high temperature" in user_input   or "i am having high fever" in user_input or "i think i have fever" in user_input or "my body temperature is high" in user_input or "i am feeling feverish" in user_input or "my body is hot" in user_input or "amar jor hoyeche" in user_input or "amar khub jor jor lagche" in user_input or "mujhe bukhar hai" in user_input or "mereko bukhar hai" in user_input or "amar mone hoche jor hoyeche" in user_input or "amar gaa gorom" in user_input:  # Check if the user wants to check for COVID-19 symptoms
        d.append('fever')
        return "Do you have any other symptoms?If yes please mention it one by one in  a sentence."
    elif "i have cough" in user_input or "i am coughing" in user_input or "i have dry cough" in user_input or "i am experiencing cough" in user_input or "i experience cough" in user_input or "i experience dry cough" in user_input or "amar khub kashi" in user_input or "ami khub kashchi" in user_input or "amar sukno kashi hoyeche" in user_input or "main khash rahi hoon" in user_input or "mujhe khasi ho rahi hain" in user_input or "ami bhishon khashchi" in user_input or "main bohot khash rahi hoon" in user_input:
        d.append("cough")
        return "Do you have any other symptoms?If yes please mention it one by one in  a sentence."
    elif "i have runny nose" in user_input or "i am have running nose" in user_input or "i am having runny nose" in user_input or "my nose is running" in user_input or "my nose is cold" in user_input or "i am having cold nose" in user_input or "amar nak theke jol porche" in user_input or "mere nak se paani gir raha hain" in user_input:
        d.append("nose")
        return "Do you have any other symptoms?If yes please mention it one by one in  a sentence."
    elif "i lost taste and smell" in user_input or "i am not getting taste of any food" in user_input or "i can not smell any thing" in user_input or "i am tasteless" in user_input or "i am not getting any taste" in user_input or "i am smelless" in user_input or "i am not getting any smell" in user_input:
        d.append("tase_smell")
        return "Do you have any other symptoms?If yes please mention it one by one in  a sentence."
        ...
        d.append("breath")
        return "Do you have any other symptoms?If yes please mention it one by one in  a sentence."
    elif "i have sore throat" in user_input  or "i am having sore throat" in user_input  or "my throat is sored" in user_input  or "amar golaye betg  " in user_input:
        d.append("throat")
        return "Do you have any other symptoms?If yes please mention it one by one in  a sentence."
    elif "i have headache" in user_input or "my head is paining" in user_input or "my head is aching" in user_input or "i having terrible headache" in user_input or "i am experiencing terrible headache" in user_input or "i am experiencing terrible head pain" in user_input or "amar matha betha korche" in user_input or "amar bhishon matha betha" in user_input or "mera sir dard kar raha hain" in user_input or "mere sir mein dard hain" in user_input:
        d.append("head")
        return "Do you have any other symptoms?If yes please mention it one by one in  a sentence."
    elif "i have diarrhea" in user_input or "i have diarrheoa" in user_input or "i think i have diarrhea" in user_input or "i think i have diarrheoa" in user_input or "i think i have diarrhea" in user_input  or "diarrhea hoyeche amar" in user_input  or "diarrhea hoyeche amar" in user_input  or "diarrhea hua hai mujhe" in user_input :
        d.append("dia")
        return "Do you have any other symptoms?If yes please mention it one by one in  a sentence."
    elif "i vomit" in user_input  or "i have nausea" in user_input or "i am vomitting" in user_input  or "i am feeling like to vomit" in user_input  or "amar bomi hoche" in user_input  or "mujhe ulti ho raha hai" in user_input:
        d.append("vomit")
        return "Do you have any other symptoms?If yes please mention it one by one in  a sentence."
    elif "i am experiencing fatigue" in user_input  or "i am getting tired" in user_input  or "i am getting overtired" in user_input  or "ami khub klanto hoye jachi" in user_input  or "main tired ho rahi hoon" in user_input  or "ami khub tired hoye jachi" in user_input:
        d.append("fatigue")
        return "Do you have any other symptoms?If yes please mention it one by one in  a sentence."
    elif "i am having muscle pain" in user_input  or "i am having body pain" in user_input or "i am having body and muscle pain" in user_input or "i have body pain" in user_input or "i have muscle pain" in user_input  or "i have body and muscle pain" in user_input or "i have terrible muscle pain" in user_input or "i have terrible body pain" in user_input  or "i am having terrible body and muscle pain" in user_input  or "i am facing body pain" in user_input  or "i am facing muscle pain" in user_input  or "i am facing body and muscle pain" in user_input or "i am experiencing muscle pain" in user_input or "i am experiencing body pain" in user_input or "i am experiencing body and muscle pain" in user_input or "i am experiencing terrible body pain" in user_input or "i am experiencing terrible muscle pain" in user_input or "i am experiencing terrible body and muscle pain" in user_input :
        d.append("body_muscle")
        return "Do you have any other symptoms?If yes please mention it one by one in  a sentence."
    
    #elif "i have " in user_input:
        
        #d.append("cough")
        
        
        #return "Do you have any other symptoms?If yes please mention it one by one in  a sentence."
    elif "i am having chest pain" in user_input or "i have chest pain" in user_input or "i am experiencing chest pain" in user_input or "i have terrible chest pain" in user_input or "i am having terrible chest pain" in user_input  or "i am facing chest pain" in user_input or "i am experiencing terrible chest pain" in user_input:
        d.append("chest")
        return "Do you have any other symptoms?If yes please mention it one by one in  a sentence."
    elif "i am having pink eye" in user_input  or "i am having conjunctivitis" in user_input or "i am having pink eyes" in user_input or "i have conjunctivitis" in user_input or "i have pink eye" in user_input  or "i have pink eyes" in user_input or "i have terrible conjunctivitis" in user_input or "i have terrible pink eye" in user_input  or "i am having terrible pink eyes" in user_input  or "i am facing conjunctivitis" in user_input  or "i am facing pink eye" in user_input  or "i am facing pink eyes" in user_input :
        d.append("conjunctivitis")
        return "Do you have any other symptoms?If yes please mention it one by one in  a sentence."
    elif "i am having rashes" in user_input or "i have rashes" in user_input or "i am experiencing rashes" in user_input or "i have terrible rashes" in user_input or "i am having terrible rashes" in user_input  or "i am facing rashes" in user_input :
        d.append("rash")
        return "Do you have any other symptoms?If yes please mention it one by one in  a sentence."
        ...
        r=len(d)
        if r>=5:
            return "You have may have Covid.Please consult with your doctor for the medication and take rest properly."
        else:
            return "you probably do not have covid but if you experience any new symptoms further please consult your doctor."
    else:
        response_key = get_closest_match(user_input, responses.keys())  # Get the closest matching response key from the dictionary
        if response_key:
            return random.choice(responses[response_key])  # Return a randomly selected response from the matched response key
        else:
            query = user_input
            search_results = list(search(query, num=1, stop=1))
            if len(search_results) == 0:
                return "I'm sorry, I couldn't find any result for that."
            else:
                response = "Here is a link for your help:\n"
                for link in search_results:
                    response += "<a href='" + link + "'>" + link + "</a>\n"
                return response  # Return a randomly selected response from the matched response key
